      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            <a href="#etapas" className="text-white/60 hover:text-primary text-sm transition-colors">
              Las 5 etapas
            </a>
            <a href="#servicios" className="text-white/60 hover:text-primary text-sm transition-colors">
              Servicios
            </a>
            <a href="#niveles" className="text-white/60 hover:text-primary text-sm transition-colors">
              Niveles
            </a>
          </div>
